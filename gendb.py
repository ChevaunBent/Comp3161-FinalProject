...
my_db.add_table(table_name="person", n_rows = 200000) #200k users required
my_db.add_table(table_name="inventory", n_rows=100) 
my_db.add_table(table_name="ingredient", n_rows=100)
my_db.add_table(table_name="measurement", n_rows=100)
my_db.add_table(table_name="meal", n_rows=100)
my_db.add_table(table_name="type", n_rows=100)
my_db.add_table(table_name="allergy", n_rows=100)
my_db.add_table(table_name="nutrition", n_rows=100)
my_db.add_table(table_name="recipe", n_rows=600000) #600k recipes required
my_db.add_table(table_name="direction", n_rows=100)
my_db.add_table(table_name="image", n_rows=100)
my_db.add_table(table_name="own", n_rows=100)
my_db.add_table(table_name="itemize", n_rows=100)
my_db.add_table(table_name="make", n_rows=100)
my_db.add_table(table_name="contain", n_rows=100)
my_db.add_table(table_name="host", n_rows=100)
my_db.add_table(table_name="schedule", n_rows=100)
my_db.add_table(table_name="prepare", n_rows=100)
my_db.add_table(table_name="reacts", n_rows=100)
